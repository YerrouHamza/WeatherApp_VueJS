<script setup lang="ts">
    ...
    const searchCity = async () => {
        ...
        await api.get(`search.json?q=${searchQuery.value}`)
            .then((res: any) => {
...
<template>
    <div class="modal-overlay z-modal" @click.self="props.closeModal()">
      <div class="bg-white w-full rounded-xl shadow-lg py-4 px-3 sm:p-8 max-w-[500px] max-h-[500px] space-y-5">
           <div class="space-y-3">
            ...
            <div v-if="searchResults.length > 0">
                <h3 class="text-md font-semibold text-gray-400 mb-2">Search Results:</h3>
                <ul class="space-y-1">
                    <li 
