    ...
    <div class="space-y-12">
        <div class="flex justify-between">
            <div class="flex justify-between items-center gap-6">
                ...
                <h2 class="text-5xl font-bold">{{ props.currentWeather?.temp_c }}°</h2>
            </div>

            <div class="space-y-1 text-right">
                <p class="font-medium text-3xl capitalize">{{ props.currentWeather?.condition.text }}</p>
                <p class="text-md text-gray-600">Feels like {{ props.currentWeather?.feelslike_c }}°</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-x-10">
            <div class="col-span-1 space-y-5">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <p class="text-black font-medium">{{ props.currentWeather?.wind_kph }} km/h</p>
                </div>
            </div>
            <div class="col-span-1 space-y-5">
                <div class="flex justify-between items-center">
                    ...
                    <p class="text-black font-medium">{{ props.currentWeather?.precip_mm }} mm</p>
                </div>
                <div class="flex justify-between items-center">
                    <span class="flex items-center gap-x-2">
